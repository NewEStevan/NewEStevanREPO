...
# Public domain deportes are from https://publicdomainmovie.net
# Here we use a hardcoded list of deportes simply for demonstrating purposes
...
def list_genres():
    ...
    xbmcplugin.setPluginCategory(HANDLE, 'DIRECTO')
    # Set plugin content. It allows Kodi to select appropriate views
    # for this type of content.
    xbmcplugin.setContent(HANDLE, 'DEPORTES')
    # Get movie genres
    genres = get_genres()
